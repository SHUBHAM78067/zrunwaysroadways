		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#RunwaysRoadwayszrunwaysroadways-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RunwaysRoadwayszrunwaysroadways-display": {
								"semanticObject": "RunwaysRoadwayszrunwaysroadways",
								"action": "display",
								"description": "Runways Roadways",
								"title": "Runways Roadways",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=RunwaysRoadways.zrunwaysroadways",
									"url": sap.ui.require.toUrl("RunwaysRoadways/zrunwaysroadways")
								}
							}
						}
					}
